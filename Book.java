...
public class Book {
	...
	public Book(String bookName, String bookPublisher, String bookAuthor, String bookDetails, double bookPriceOther, double bookPriceSite) {
		name = bookName; publisher = bookPublisher; author = bookAuthor; details = bookDetails; priceOther = bookPriceOther; priceSite = bookPriceSite;
		parseDetails();
	}
	...
	public void setDetails(String bookDetails) { details = bookDetails; }
	...
	public String parseDetails() {
		...
		// 6053609902 | 18. Baský | TÜRKÇE | 136 | Karton Kapak | Kitap Kaðýdý 2019-05-24
